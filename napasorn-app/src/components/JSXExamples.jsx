...
function JSXExamples() {
    ...
    const user = {
        ...
        lastName: 'เพชรศิริ',
        age: 22,
        hobbies: ['ดูซีรี่ย์', 'ฟังเพลง', 'เล่นบอร์ดเกม']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'บลัชออน', price: 239, inStock: true },
                        { id: 2, name: 'ลิปสติก', price: 290, inStock: true },
                        { id: 3, name: 'อายไลน์เนอร์', price: 199, inStock: false }
                    ].map(product => (
